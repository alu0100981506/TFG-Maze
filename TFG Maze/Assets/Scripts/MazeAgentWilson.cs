...
namespace Maze
{
    ...
    public class MazeAgentWilson : Agent
    {

        //  public bool taged { get; private set; }

        protected MazeAreaWilson area;
        ...
        void Start()
        {
            ...
            area = GetComponentInParent<MazeAreaWilson>();
            if (area == null) {
                Debug.Log("Ey yo no encuentro el area men");
            }
            csvPath = "";
